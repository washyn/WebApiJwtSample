...
{
    public ILogger<WebDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly WebEFCoreDbSchemaMigrator _dbSchemaMigrator;
    // private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public WebDbMigrationService(
        IDataSeeder dataSeeder,
        WebEFCoreDbSchemaMigrator dbSchemaMigrator,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<WebDbMigrationService>.Instance;
    }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Acme.BookStore.Web");
    }
