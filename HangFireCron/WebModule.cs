...
public class WebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHangfire(conf =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        var backgroundJobs = context.ServiceProvider.GetRequiredService<IBackgroundJobClient>();
        ...
        app.UseHangfireDashboard("/hangfire",
            new DashboardOptions { Authorization = new[] { new DashboardAuthorization()} });
        RecurringJob.AddOrUpdate<CleanInfo>(nameof(CleanInfo), x => x.Execute(), "0 0 0 * * *");
...
// agrega buenas practicas, agregar archivos de convenciones...