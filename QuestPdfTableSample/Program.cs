            ...
            page.Content()
                .Column(x =>
                {
                    ...
                    x
                        ...
                        {
                            text.AlignCenter();
                            text.Span("ASISTENCIA DE COMISION EN EL EXAMEN DE ADMISION MODALIDAD CEPRE SEGUNDA FASE")
                                .Bold();
                        });
                    ...
                    x.Item().Table(table =>
                    {
                        ...
                        for (int i = 0; i < 20; i++)
                        {
                            ...
                            table.Cell().Element(CellNormal).Text("Washington Acero Mamani Mamani".ToUpperInvariant())
                                .Style(styleTextCell);
